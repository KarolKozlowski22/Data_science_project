...
with open('gpt_summary.txt', 'w') as f:
    f.write(f"Number of samples: {num_samples}")
    f.write(f"Number of features (pixels per image): {num_features}")
...
plt.savefig('gpt_class_distribution.png')
...
plt.savefig('gpt_sample_images.png')
